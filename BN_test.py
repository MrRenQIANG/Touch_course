...
f, axes = plt.subplots(4,N_HIDDEN+1, figsize=(10,5))
plt.ion()


def plot_histogram(l_in, l_in_bn, pre_ac, pre_ac_bn):
    for i, (ax_pa, ax_pa_bn, ax,  ax_bn) in enumerate(zip(axes[0, :], axes[1, :], axes[2, :], axes[3, :])):
        ...
        axes[0, 0].set_ylabel('PreAct');axes[1, 0].set_ylabel('BN PreAct');axes[2, 0].set_ylabel('Act');axes[3, 0].set_ylabel('BN Act')
    plt.pause(0.01)
